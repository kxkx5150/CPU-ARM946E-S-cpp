...
class Settings {
  public:
    ...
    static void setBios9Path(std::string value)
    {
        bios9Path = value;
    }
    static void setBios7Path(std::string value)
    {
        bios7Path = value;
    }
    static void setFirmwarePath(std::string value)
    {
        firmwarePath = value;
    }
    static void setGbaBiosPath(std::string value)
    {
        gbaBiosPath = value;
    }
    static void setSdImagePath(std::string value)
    {
        sdImagePath = value;
    }
