...
class Wifi {
  public:
    ...
    uint16_t readWMacaddr(int index)
    {
        return wMacaddr[index];
    }
    uint16_t readWBssid(int index)
    {
        return wBssid[index];
    }
    uint16_t readWAidFull()
    {
        return wAidFull;
    }
    uint16_t readWRxcnt()
    ...
    uint16_t readWPowerstate()
    {
        return wPowerstate;
    }
    uint16_t readWPowerforce()
    {
        return wPowerforce;
    }
    uint16_t readWRxbufBegin()
    {
        return wRxbufBegin;
    }
    uint16_t readWRxbufEnd()
    {
        return wRxbufEnd;
    }
    uint16_t readWRxbufWrcsr()
    {
        return wRxbufWrcsr >> 1;
    }
    uint16_t readWRxbufWrAddr()
    {
        return wRxbufWrAddr;
    }
    uint16_t readWRxbufRdAddr()
    {
        return wRxbufRdAddr;
    }
    uint16_t readWRxbufReadcsr()
    {
        return wRxbufReadcsr;
    }
    uint16_t readWRxbufGap()
    {
        return wRxbufGap;
    }
    uint16_t readWRxbufGapdisp()
    {
        return wRxbufGapdisp;
    }
    uint16_t readWRxbufCount()
    {
        return wRxbufCount;
    }
    uint16_t readWTxbufWrAddr()
    {
        return wTxbufWrAddr;
    }
    uint16_t readWTxbufCount()
    {
        return wTxbufCount;
    }
    uint16_t readWTxbufGap()
    {
        return wTxbufGap;
    }
    uint16_t readWTxbufGapdisp()
    {
        return wTxbufGapdisp;
    }
    uint16_t readWTxbufLoc(int index)
    {
        return wTxbufLoc[index];
    }
    uint16_t readWBeaconInt()
    {
        return wBeaconInt;
    }
    uint16_t readWTxreqRead()
    {
        return wTxreqRead;
    }
    uint16_t readWUsCountcnt()
    {
        return wUsCountcnt;
    }
    uint16_t readWUsComparecnt()
    {
        return wUsComparecnt;
    }
    uint16_t readWPreBeacon()
    {
        return wPreBeacon;
    }
    uint16_t readWBeaconCount()
    {
        return wBeaconCount;
    }
    uint16_t readWConfig(int index)
    {
        return wConfig[index];
    }
    uint16_t readWPostBeacon()
    {
        return wPostBeacon;
    }
    uint16_t readWBbRead()
    {
        return wBbRead;
    }
